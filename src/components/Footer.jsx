    ...
    <footer className="bg-green-800 text-gray-100 pt-6 pb-4 font-heading">
      ...
      <div className="mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-4">
          <a href="https://wa.me/6282255695790" className={iconStyle}><FontAwesomeIcon icon={faWhatsapp}/></a>
          <a href="https://mailto:cahyapatrabuana@gmail.com" className={iconStyle}><FontAwesomeIcon icon={faEnvelope}/></a>
